...
<html lang="en">
<head>
    <title>Code coverage report for lib/TestItem.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/TestItem.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; TestItem.js</div>
</div>
<div class="body">
...
TestItem.prototype.run = function (callback) {
  if(this.isInProgress) {
    logger('info', ' fh-health: Called run method for ' +
      'test ' + this.getDescription() +  ' while it was already' +
      ' running. Will not run again until first run is complete.');
  } else {
    var self = this,
      startTime = Date.now(),
      timedOut = false;
