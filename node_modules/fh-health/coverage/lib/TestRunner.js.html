...
<html lang="en">
<head>
    <title>Code coverage report for lib/TestRunner.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/TestRunner.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.65% <small>(59 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">83.33% <small>(15 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">88.89% <small>(16 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">93.65% <small>(59 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; TestRunner.js</div>
</div>
<div class="body">
...
&nbsp;
function log(str) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if(silent === false) {
<span class="cstat-no" title="statement not covered" >    logger('info', str);</span>
  }
}
&nbsp;
&nbsp;
...
&nbsp;
exports.logger = {
  enableLogColours: <span class="fstat-no" title="function not covered" >function (val) {</span>
<span class="cstat-no" title="statement not covered" >    logger.setColorizedLogs(val);</span>
  },
  enableJsonOutput: <span class="fstat-no" title="function not covered" >function (val) {</span>
<span class="cstat-no" title="statement not covered" >    logger.enableJsonFormatedLogs(val);</span>
  }
};
&nbsp;
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if(res['status'] != STATUSES.TYPES.CRITICAL) {
          testStatus = STATUSES.TYPES.WARN;
&nbsp;
          // We don't want to overwrite a critical
          // overall status if one is set
          <span class="missing-if-branch" title="else path not taken" >E</span>if (res['status'] != STATUSES.TYPES.CRITICAL) {
...
<span class="cstat-no" title="statement not covered" >      res = 'Could not create JSON response. Test results contained a ' +</span>
        ' circular reference.';
    }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Nov 09 2014 19:09:39 GMT-0500 (EST)</div>
</div>
